        ...
        <div class="row plan-row"> 
            <div class="col-xs-2 plan-desc">
                <div class="panel panel-default text-right">
                    ...
                    <div class="panel-body" style="background:transparent;"> 
                        <h4 class="price">Monthly Price</h4>           
                        <ul class="features">
            ...
            <div class="col-xs-2 plan plan-1">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"> 
                        ...
                        <ul class="features">
                            <li class="text-primary">$12 / member</li>
                            <li>1</li>
            ...
            <div class="col-xs-2 plan plan-2">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="features">
                            <li class="text-primary">$6.40 / member</li>
                            <li>Up to 5</li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
            ...
            <div class="col-xs-2 plan plan-3">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"> 
                        ...
                        <ul class="features">
                            <li class="text-primary">$5.20 / member</li>
                            <li>Up to 10</li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
           ...
           <div class="col-xs-2 plan plan-4">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"> 
                        <h4 class="price">$82</h4>           
                        <ul class="features">
                            <li class="text-primary">$4.10 / member</li>
                            <li>Up to 20</li>                            
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
           ...
           <div class="col-xs-2 plan plan-5">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body"> 
                        ...
                        <ul class="features">
                            <li class="text-primary">$3.43 / member</li>
                            <li>Up to 35</li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
                            <li><i class="fa fa-check"></i></li>
